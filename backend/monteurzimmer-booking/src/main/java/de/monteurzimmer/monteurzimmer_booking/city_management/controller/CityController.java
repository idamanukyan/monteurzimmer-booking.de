...
public class CityController {
    ...
    public ResponseEntity<CityDto> addCity(@RequestParam("name") String name,
        ...
        try {
            ...
            logEntryService.log("error", "Error storing photo: {}," + e.getMessage());
    ...
    public ResponseEntity<CityDto> getCityById(@PathVariable Long id) {
        try {
            ...
            logEntryService.log("error", "City not found: {}" + e.getMessage());
    ...
    public ResponseEntity<City> markAsFavorite(@PathVariable Long id) {
        try {
            ...
            logEntryService.log("error", "Error marking city as favorite: {}" + e.getMessage());
            return ResponseEntity.notFound().build();
        }
    }
    ...
    public ResponseEntity<City> unmarkAsFavorite(@PathVariable Long id) {
        try {
            ...
            logEntryService.log("error", "Error unmarking city as favorite: {}" + e.getMessage());
            return ResponseEntity.notFound().build();
        }
    }
}
