...
(property_name, property_type, description, location, rating, is_available, country, city,
 ...
 social_media_link, price, is_favorite)

VALUES ('Cosy Apartment', 'Wohnung', 'A quiet apartment in the city center.', 'Berlin', 4.5, TRUE, 'Germany',
        'Berlin', 2, 3, TRUE, TRUE, FALSE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, TRUE, TRUE,
        TRUE, TRUE, TRUE, TRUE, FALSE, TRUE, FALSE, TRUE, TRUE, TRUE,
        'Mitte', 4.8, 1, 52.5200, 13.4050, 'https://www.monteurzimmer.de/wohnung/13597-berlin-d409273a52',75.00,true),

       ('Modern Guesthouse', 'Gastezimmer', 'A modern guesthouse close to public transport.', 'Hamburg', 4.2,
        ...
        'https://www.monteurzimmer.de/wohnung/14471-potsdam-e4178fa552?booking_adults=1',55.00,false),

       ('Charming Cottage', 'Haus', 'A charming cottage with a beautiful garden.', 'Munich', 4.7, TRUE,
        ...
        'https://www.monteurzimmer.de/wohnung/22765-hamburg-b9d04aab52?booking_adults=1',100.00,true),

       ('Luxury Villa', 'Haus', 'A luxurious villa with a private pool.', 'Frankfurt', 4.9, TRUE, 'Germany',
        ...
        'https://www.monteurzimmer.de/wohnung/24113-kiel-bd895f6652?booking_adults=1',250.00,false),

       ('Budget Pension', 'Pension', 'Affordable pension with basic amenities.', 'Cologne',  3.9, TRUE,
        'Germany', 'Cologne', 1, 1,
        ...
        'https://www.monteurzimmer.de/wohnung/39112-magdeburg-03bb134852?booking_adults=1',40.00,false),
       ...
       ('City Center Hotel', 'Hotel', 'Hotel in the heart of the city with all amenities.', 'Düsseldorf',
        ...
        'https://www.monteurzimmer.de/wohnung/04103-leipzig-ed704ae352?booking_adults=1',150.00,true),

       ('Quiet Countryside Retreat', 'Herberge', 'A peaceful retreat in the countryside.', 'Stuttgart', 4.4,
        ...
        9.1829, 'https://www.monteurzimmer.de/wohnung/93053-regensburg-076edd2752?booking_adults=1',85.00,true),

       ('Comfy Pension', 'Pension', 'Comfortable pension with friendly staff.', 'Leipzig',  4.3, TRUE,
        ...
        'https://www.monteurzimmer.de/wohnung/60598-frankfurt-am-main-de0af43c52?booking_adults=1',60.00,true),

       ('Historic Mansion', 'Haus', 'A grand historic mansion with modern amenities.', 'Nuremberg', 4.8,
        ...
        'https://www.monteurzimmer.de/wohnung/41460-neuss-fb08935831?booking_adults=1',180.00,true),

       ('Studio Apartment', 'Wohnung', 'A small, modern studio apartment.', 'Bremen', 4.1, TRUE, 'Germany',
        ...
        'https://www.monteurzimmer.de/wohnung/47608-geldern-1bd13ae74e?booking_adults=1',45.00,false);