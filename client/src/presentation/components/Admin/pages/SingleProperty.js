    ...
    useEffect(() => {
        const fetchProperty = async () => {
            try {
                ...
                setError('Failed to load property data. Please try again later.'); // Set error message
            }
        };
        ...
        <div className="property-details">
            ...
            <table className="property-table">
                ...
                <tr>
                    ...
                    <td>
                        <button className="open-link-button" onClick={() => window.open(property.socialMediaLink, '_blank')}>
                            View Offer
                        </button>
                    </td>
                </tr>
            ...
            <table className="boolean-values-table">
                ...
                <tr>
                    ...
                    <td>{property.cookingFacilities ? <img src={cookingFacilities} alt="cookingFacilities" className="icon" /> : 'No'}</td>
                </tr>
                <tr>
                    <td>Separate Beds</td>
                    <td>{property.separateBeds ? <img src={separateBeds} alt="separateBeds" className="icon" /> : 'No'}</td>
                </tr>
                <tr>
                    <td>Radio</td>
                ...
                <tr>
                    ...
                    <td>{property.coffeeMachine ? <img src={coffeeMachine} alt="coffeeMachine" className="icon" /> : 'No'}</td>
                </tr>
                <tr>
                    <td>Microwave</td>
                ...
                <tr>
                    ...
                    <td>{property.cookingUtensils ? <img src={cookingUtensils} alt="cookingUtensils" className="icon" /> : 'No'}</td>
                </tr>
                <tr>
                    <td>Washing Machine</td>
                    <td>{property.washingMachine ? <img src={washingMachine} alt="washingMachine" className="icon" /> : 'No'}</td>
                </tr>
                <tr>
                    <td>Smoking</td>
                ...
                <tr>
                    ...
                    <td>{property.quietLocation ? <img src={quietLocation} alt="quietLocation" className="icon" /> : 'No'}</td>
                </tr>
                <tr>
                    <td>Good Transportation</td>
                    <td>{property.goodTransportation ? <img src={goodTransportation} alt="goodTransportation" className="icon" /> : 'No'}</td>
                </tr>
                <tr>
                    <td>Shops Nearby</td>
